	...
	public class SBAlchemist : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				// Removed by Silver: Add(new GenericBuyInfo(typeof(HeatingStand), 2, 100, 0x1849, 0)); // This is on OSI :-P

				// Removed by Silver: Add(new GenericBuyInfo(typeof(BloodDrainToolkit), 5000, 100, 0x1EBA, 0));
			}
		}
