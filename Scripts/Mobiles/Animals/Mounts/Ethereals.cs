...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, IRewardItem
	{
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if( m_IsDonationItem )
			{
				...
				//list.Add("No Age Ethereal"); // Disabled by Silver
			}
		...
		public override void Deserialize( GenericReader reader )
		{
				...
				case 4:
					{
						...
						m_IsRewardItem = reader.ReadBool();// *** Sunny Edit
			...
			if (!m_IsDonationItem && Name == "No Age Ethereal")
			...
			set
			{
				if( value != m_Rider )
				{
					...
					else
					{
						...
						// ***
						m_OriginalHue = Hue;
						if (!(this is EtherealWarHorse) && m_Rider is PlayerMobile && ((PlayerMobile)m_Rider).HasDonated && ((PlayerMobile)m_Rider).DonationTimeLeft >= TimeSpan.FromDays(90.0) && m_OriginalHue == 0 )
							 Hue = DonationSystem.GetHorseHue((Account)m_Rider.Account);
						// ***
	...
	public class EtherealHorseAoS : EtherealMount
	{
		public override int LabelNumber { get { return 1041298; } } // Ethereal Horse Statuette

		[Constructable]
		public EtherealHorseAoS()
			: base(0x20DD, 0x3EAA)
		{
			IsDonationItem = true;
		}

		public EtherealHorseAoS(Serial serial)
			: base(serial)
		{
		}
	...
	public class EtherealLlamaAoS : EtherealMount
	{
		public override int LabelNumber { get { return 1041300; } } // Ethereal Llama Statuette

		[Constructable]
		public EtherealLlamaAoS()
			: base(0x20F6, 0x3EAB)
		{
			IsDonationItem = true;
		}

		public EtherealLlamaAoS(Serial serial)
			: base(serial)
		{
		}
	...
	public class EtherealOstardAoS : EtherealMount
	{
		public override int LabelNumber { get { return 1041299; } } // Ethereal Ostard Statuette

		[Constructable]
		public EtherealOstardAoS()
			: base(0x2135, 0x3EAC)
		{
			IsDonationItem = true;
		}

		public EtherealOstardAoS(Serial serial)
			: base(serial)
		{
		}
	...
	public class EtherealUnicornAoS : EtherealMount
	{
		public override int LabelNumber { get { return 1049745; } } // Ethereal Unicorn Statuette

		[Constructable]
		public EtherealUnicornAoS()
			: base(0x25CE, 0x3E9B)
		{
			IsDonationItem = true;
		}

		public EtherealUnicornAoS(Serial serial)
			: base(serial)
		{
		}
