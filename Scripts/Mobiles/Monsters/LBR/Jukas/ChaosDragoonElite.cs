...
namespace Server.Mobiles
{
	...
	{
		public override string DefaultName{ get{ return "a chaos dragoon elite"; } }
		...
		public override void OnGaveMeleeAttack( Mobile defender )
		{
			...
			if ( DateTime.Now >= m_NextAbilityTime )
			{
				...
				m_NextAbilityTime = DateTime.Now + TimeSpan.FromSeconds( Utility.RandomMinMax( 60, 120 ) );
			}
		}
		...
		public void StompAttack( Mobile target )
		{
			if ( target.GetStatMod( "StompAttack" ) == null )
			{
				...
				target.AddStatMod( new StatMod( type, "StompAttack", -( 20 + Utility.Random( 15 ) ), TimeSpan.FromSeconds( 60 + Utility.Random( 60 ) ) ) );
			}
		}
