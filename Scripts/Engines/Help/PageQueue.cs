...
namespace Server.Engines.Help
{
		...
		private class InternalTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				if ( m_Entry.Sender.NetState != null && index != -1 )
				{
					...
					m_Entry.Sender.SendMessage( "You can reference our website at www.DefianceUO.com or contact us at http://www.defianceuo.com/forum. To cancel your page, please select the help button again and select cancel.");
	...
	public class PageQueue
	{
		...
		public static void Enqueue( PageEntry entry )
		{
			...
			if ( !isStaffOnline )
				entry.Sender.SendMessage( "We are sorry, but no staff members are currently available to assist you.  Your page will remain in the queue until one becomes available, or until you cancel it manually, or logout." );
		...
		private static void SendEmail( PageEntry entry )
		{
			...
			MailMessage mail = new MailMessage( "noreply@defianceuo.com", Email.SpeechLogPageAddresses );
