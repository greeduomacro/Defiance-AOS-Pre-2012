...
namespace Server.Engines.Craft
{
	...
	public class Enhance
	{
		...
		public static int GetChance( AosAttribute attr, AosAttributes itemAttrs )
		{
			...
			switch ( attr )
			{
				case AosAttribute.LowerWeight: 					chance = itemAttrs[attr] / 50; break;
				case AosAttribute.WeaponDamage:					chance = itemAttrs[attr] / 5; break;
				case AosAttribute.Luck: 						chance = 8 + itemAttrs[attr] / 2; break;
				default:
