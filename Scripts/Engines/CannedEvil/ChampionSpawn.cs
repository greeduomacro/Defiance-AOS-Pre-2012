...
namespace Server.Engines.CannedEvil
{
	public class ChampionCommands
	{
		...
		{
			CommandSystem.Register( "ClearChampByTarget", AccessLevel.Seer, new CommandEventHandler( KillByTarget_OnCommand ) );
			CommandSystem.Register( "ClearChampByRegion", AccessLevel.Seer, new CommandEventHandler( KillByRegion_OnCommand ) );
		}
		...
		private class KillTarget : Target
		{
			...
			{
				if ( from == null || from.AccessLevel < AccessLevel.Seer )
					return;
