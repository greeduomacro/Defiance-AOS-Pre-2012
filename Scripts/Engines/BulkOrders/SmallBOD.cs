...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		private Mobile m_Mobile; //Added by Blady - smallbods can be returned only by the char who received them

		[CommandProperty(AccessLevel.Seer)]
		public Mobile Mobile
		{
			get { return m_Mobile; }
			set { m_Mobile = value; InvalidateProperties(); }
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			//Added by Blady:
			if ( m_Mobile != null )
				list.Add( 1060659, "ordered to\t{0}", m_Mobile.Name );
		}
