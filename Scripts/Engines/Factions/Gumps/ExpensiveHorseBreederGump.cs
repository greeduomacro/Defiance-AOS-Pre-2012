...
{
	public class ExpensiveHorseBreederGump : FactionGump
	{
		private PlayerMobile m_From;
		private Faction m_Faction;

		public ExpensiveHorseBreederGump( PlayerMobile from, Faction faction ) : base( 20, 30 )
		{
			m_From = from;
			m_Faction = faction;
			...
			AddLabel( 190, 152, 0x3E3, (FactionWarHorse.GoldPrice * 4).ToString( "N0" ) ); // NOTE: Added 'N0'
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else
			{
				...
				else if ( pack.GetAmount( typeof( Gold ) ) < FactionWarHorse.GoldPrice * 4 )
				{
					sender.Mobile.SendLocalizedMessage( 1042205 ); // You do not have enough gold.
					horse.Delete();
				}
				else if ( pack.ConsumeTotal( typeof( Silver ), FactionWarHorse.SilverPrice ) && pack.ConsumeTotal( typeof( Gold ), FactionWarHorse.GoldPrice * 4 ) )
				{
