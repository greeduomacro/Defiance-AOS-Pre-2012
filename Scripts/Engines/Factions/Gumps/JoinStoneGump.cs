...
namespace Server.Factions
{
	public class JoinStoneGump : FactionGump
	{
		...
		public JoinStoneGump( PlayerMobile from, Faction faction ) : base( 20, 30 )
		{
			...
			AddHtmlText( 20, 280, 510, 100, "WARNING!<BR>If you join the faction, you will be <U>attackable</U> to all enemy faction members, and you will not be able to leave the faction for 2 days.", false, false );
