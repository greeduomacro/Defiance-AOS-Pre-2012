...
namespace Server.Factions
{
	public class FactionItemDefinition
	{
		...
		private static FactionItemDefinition m_RangedWeapon	= new FactionItemDefinition(  750, typeof( Bowyer ), CraftSkillType.Fletching );
		private static FactionItemDefinition m_LeatherArmor	= new FactionItemDefinition(  200, typeof( Tailor ), CraftSkillType.Tailoring );
		private static FactionItemDefinition m_Clothing		= new FactionItemDefinition(  100, typeof( Tailor ), CraftSkillType.Tailoring );
