...
namespace Server.Multis
{
	public class HouseSign : Item
	{
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list )
		{
			...
			if ( Owner.AreTherePetsOwnedBy( from ) ) // Added by Silver
				list.Add( new KickPetsEntry( this ) );
		}
		...
		private class KickPetsEntry : ContextMenuEntry // Added by Silver
		{
			private HouseSign m_Sign;

			public KickPetsEntry( HouseSign sign ) : base( 6181 )
			{
				m_Sign = sign;
			}
			...
			public override void OnClick()
			{
				...
				if ( m_Sign.Deleted || m_Sign.Owner == null || !m_Sign.Owner.AreTherePetsOwnedBy( from ) || !from.CheckAlive() )
					return;
