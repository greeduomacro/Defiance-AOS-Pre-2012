...
namespace Server.Commands
{
	public class MapCommands
	{
		...
		{
			CommandSystem.Register( "CreateMap", AccessLevel.Administrator, new CommandEventHandler( CreateMap_OnCommand ) );
			CommandSystem.Register( "DeleteMap", AccessLevel.Administrator, new CommandEventHandler( DeleteMap_OnCommand ) );
		}
