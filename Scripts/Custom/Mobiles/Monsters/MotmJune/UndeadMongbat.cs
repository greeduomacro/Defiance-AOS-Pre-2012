...
namespace Server.Mobiles
{
	...
	public class UndeadMongbat : BaseCreature
	{
		[Constructable]
		public UndeadMongbat() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an undead mongbat";
			Body = 39;
			Hue = 16385;
			BaseSoundID = 422;
		...
		public UndeadMongbat( Serial serial ) : base( serial )
		{
		}
