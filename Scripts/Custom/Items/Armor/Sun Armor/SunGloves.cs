...
namespace Server.Items
{
	...
	public class SunGloves : BaseArmor
	{
		...
		public override bool OnEquip( Mobile from )
		{
			...
			if ( ( tHelm != null ) && ( tLegs != null ) && ( tGorget != null ) && ( tSleeves != null ) && ( tArmor != null ) )
			{
				if ( ( tHelm is SunHelm ) && ( tLegs is SunLegs ) && ( tGorget is SunGorget ) && ( tSleeves is SunArms ) && ( tArmor is SunArmor ) )
				{
		...
		public SunGloves( Serial serial ) : base( serial )
		{
		}
