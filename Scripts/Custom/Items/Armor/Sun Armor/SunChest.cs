...
namespace Server.Items
{
	...
	public class SunArmor : BaseArmor
	{
		...
		public override bool OnEquip( Mobile from )
		{
			...
			if ( ( tHelm != null ) && ( tLegs != null ) && ( tGorget != null ) && ( tSleeves != null ) && ( tGloves != null ) )
			{
				if ( ( tHelm is SunHelm ) && ( tLegs is SunLegs ) && ( tGorget is SunGorget ) && ( tSleeves is SunArms ) && ( tGloves is SunGloves ) )
				{
		...
		public SunArmor( Serial serial ) : base( serial )
		{
		}
