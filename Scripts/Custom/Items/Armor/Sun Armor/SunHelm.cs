...
namespace Server.Items
{
	...
	public class SunHelm : BaseArmor
	{
		...
		public override bool OnEquip( Mobile from )
		{
			...
			if ( ( tArmor != null ) && ( tLegs != null ) && ( tGorget != null ) && ( tSleeves != null ) && ( tGloves != null ) )
			{
				if ( ( tArmor is SunArmor ) && ( tLegs is SunLegs ) && ( tGorget is SunGorget ) && ( tSleeves is SunArms ) && ( tGloves is SunGloves ) )
				{
		...
		public SunHelm( Serial serial ) : base( serial )
		{
		}
