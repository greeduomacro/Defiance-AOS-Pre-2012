...
{
	public class WorstFactionScoreBoard : Item
	{
		[Constructable]
		public WorstFactionScoreBoard() : base( 0x1e5e )
		{
			this.Movable = false;
			this.Name = "Worst Faction Score Board";
		}

		public WorstFactionScoreBoard( Serial serial ) : base(serial)
		{
		}
		...
		{
			list.Add( Utility.FixHtml( "Worst Faction Score Board" ) );
		}

		public override void OnDoubleClick( Mobile from )
		{
			from.CloseGump( typeof( WorstFactionScoreBoardGump ) );
			from.SendGump( new WorstFactionScoreBoardGump( (PlayerMobile)from ) );
		}
	}
}
...
{
	public class WorstFactionScoreComparer : IComparer
	{
	...
	public class WorstFactionScoreBoardGump : Gump
	{
		public WorstFactionScoreBoardGump( PlayerMobile from ) : base( 20, 30 )
		{
			this.Closable=true;
