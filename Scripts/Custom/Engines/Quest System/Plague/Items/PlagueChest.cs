...
{
	[Flipable]
	public class PlagueChest : LockableContainer
	{
		...
		[Constructable]
		public PlagueChest( string name, int level ) : base( Utility.RandomList( m_ItemIDs ) )
		{
			m_Name = name;
			Hue = Utility.RandomList( m_Hues );
			Fill( level );
			DropItem( new TreasureMap( level, Map.Felucca ) );
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1070722, "recovered from {0} (plagued)", m_Name );
		}
		...
		public PlagueChest( Serial serial ) : base( serial )
		{
		}
