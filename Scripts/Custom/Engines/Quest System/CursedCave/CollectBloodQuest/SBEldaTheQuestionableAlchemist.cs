...
{
    public class SBEldaTheQuestionableAlchemist : SBInfo
    {
		private List<IBuyItemInfo> m_BuyInfo = new InternalBuyInfo();
		private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBEldaTheQuestionableAlchemist()
        {
        }
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(Bottle), 5, 900, 0xF0E, 0));
                ...
                Add(new GenericBuyInfo(typeof(ConfusionBlastPotion), 20, 10, 0xF06, 0x48D));
                Add(new GenericBuyInfo(typeof(ConflagrationPotion), 20, 10, 0xF06, 0x489));

                Add(new GenericBuyInfo(typeof(BloodDrainToolkit), 5000, 900, 0x1EBA, 0));
            }
        }
