...
namespace Knives.TownHouses
{
	public class Errors
	{
		...
		{
			RUOVersion.AddCommand("TownHouseErrors", AccessLevel.GameMaster, new TownHouseCommandHandler(OnErrors));
			RUOVersion.AddCommand("the", AccessLevel.GameMaster, new TownHouseCommandHandler(OnErrors));
