...
namespace Server.Items
{
	...
	public class RumRedDonationBoxAos : MetalBox
	{
		[Constructable]
		public RumRedDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1645;
			Item item = null;
			Name = "Defiance Rum Member Box of Holding";
			...
			item.Hue = 1645;
			item.Name = "Rum Shroud of Shadows";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1645; //Utility.RandomList(1150, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.RumRed; //Blady
		...
		public RumRedDonationBoxAos( Serial serial ) : base( serial )
		{
		}
