...
namespace Server.Items
{
	...
	public class ParaGoldDonationBoxAoS : MetalBox
	{
		[Constructable]
		public ParaGoldDonationBoxAoS()
		{
			Weight = 1.0;
			Hue = 1281;
			Item item = null;
			Name = "Defiance Paragon Member Box of Holding";
			...
			item.Hue = 1281;
			item.Name = "Paragon Shroud of Shadows";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1281; //Utility.RandomList(1150, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.ParagonGold; //Blady
		...
		public ParaGoldDonationBoxAoS( Serial serial ) : base( serial )
		{
		}
