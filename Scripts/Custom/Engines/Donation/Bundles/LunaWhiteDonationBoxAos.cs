...
namespace Server.Items
{
	...
	public class LunaWhiteDonationBoxAos : MetalBox
	{
		[Constructable]
		public LunaWhiteDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1150;
			Item item = null;
			Name = "Defiance Luna Member Box of Holding";
			...
			item.Hue = 1150;
			item.Name = "Luna Shroud of Shadows";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1150; //Utility.RandomList(1150, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.LunaWhite; //Blady
		...
		public LunaWhiteDonationBoxAos( Serial serial ) : base( serial )
		{
		}
