...
namespace Server.Items
{
	...
	public class DryadGreenDonationBoxAos : MetalBox
	{
		[Constructable]
		public DryadGreenDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1167;
			Item item = null;
			Name = "Defiance Dryad Green Member Box of Holding";
			...
			item.Hue = 1167;
			item.Name = "Dryad Shroud of Shadows";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1167; //Utility.RandomList(1167, 1281, 1161, 1167, 1167, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.DryadGreen;
		...
		public DryadGreenDonationBoxAos( Serial serial ) : base( serial )
		{
		}
