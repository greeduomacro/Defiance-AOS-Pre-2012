...
namespace Server.Items
{
	...
	public class DarkPurpleDonationBoxAos : MetalBox
	{
		[Constructable]
		public DarkPurpleDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1273;
			Item item = null;
			Name = "Defiance Purple Member Box of Holding";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = Utility.RandomList(1273, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
		...
		public DarkPurpleDonationBoxAos( Serial serial ) : base( serial )
		{
		}
