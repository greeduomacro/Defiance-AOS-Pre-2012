...
namespace Server.Items
{
	...
	public class DarkSeerGreenDonationBoxAos : MetalBox
	{
		[Constructable]
		public DarkSeerGreenDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1367;
			Item item = null;
			Name = "Defiance Dark Green Member Box of Holding";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = Utility.RandomList(1150, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1367);
			item.LootType = LootType.Blessed;
		...
		public DarkSeerGreenDonationBoxAos( Serial serial ) : base( serial )
		{
		}
