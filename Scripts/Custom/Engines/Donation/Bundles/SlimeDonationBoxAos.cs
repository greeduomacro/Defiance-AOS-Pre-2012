...
namespace Server.Items
{
	...
	public class SlimeDonationBox : MetalBox
	{
		[Constructable]
		public SlimeDonationBox()
		{
			Weight = 1.0;
			Hue = 1367;
			Item item = null;
			Name = "Defiance Slime Member Box of Holding";
			...
			item.Hue = 1367;
			item.Name = "Slime Shroud of Shadows";
			...
			item.Hue = 1367; //Utility.RandomList(1367, 1281, 1161, 1367, 1367, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;

			CharacterCreation.PlaceItemIn( this, 122, 53, new SpecialDonateDye() );
			CharacterCreation.PlaceItemIn(this, 11367, 53, (item = new PigmentsOfTokuno( 5 )));
		...
		public SlimeDonationBox( Serial serial ) : base( serial )
		{
		}
