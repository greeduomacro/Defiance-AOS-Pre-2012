...
namespace Server.Items
{
	...
	public class FireOrangeDonationBoxAos : MetalBox
	{
		[Constructable]
		public FireOrangeDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1359;
			Item item = null;
			Name = "Defiance Fire Orange Member Box of Holding";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1359; //Utility.RandomList(1359, 1281, 1161, 1359, 1359, 1359, 1266, 1359, 1359, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.FireOrange;
		...
		public FireOrangeDonationBoxAos( Serial serial ) : base( serial )
		{
		}
