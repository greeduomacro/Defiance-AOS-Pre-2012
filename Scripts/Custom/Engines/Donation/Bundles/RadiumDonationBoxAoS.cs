...
namespace Server.Items
{
	...
	public class RadiumDonationBoxAoS : MetalBox
	{
		[Constructable]
		public RadiumDonationBoxAoS()
		{
			Weight = 1.0;
			Hue = 1372;
			Item item = null;
			Name = "Defiance Radium Member Box of Holding";
			...
			item.Hue = 1372;
			item.Name = "Radium Shroud of Shadows";
		...
		public RadiumDonationBoxAoS( Serial serial ) : base( serial )
		{
		}
