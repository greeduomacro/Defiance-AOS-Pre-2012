...
namespace Server.Items
{
	...
	public class ShadowBlackDonationBoxAos : MetalBox
	{
		[Constructable]
		public ShadowBlackDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1109;
			Item item = null;
			Name = "Defiance Shadow Black Member Box of Holding";
			...
			item.Hue = 1109;
			//item.Name = "Shadow Black Shroud of Shadows";
		...
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1109; //Utility.RandomList(1109, 1281, 1161, 1109, 1109, 1109, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.ShadowDancerBlack;
		...
		public ShadowBlackDonationBoxAos( Serial serial ) : base( serial )
		{
		}
