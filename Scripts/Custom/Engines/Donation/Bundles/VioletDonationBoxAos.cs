...
namespace Server.Items
{
	...
	public class VioletDonationBoxAos : MetalBox
	{
		[Constructable]
		public VioletDonationBoxAos()
		{
			Weight = 1.0;
			Hue = 1158;
			Item item = null;
			Name = "Defiance Violet Member Box of Holding";
			...
			item.Hue = 1158; //Utility.RandomList(1158, 1281, 1161, 1158, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;

			CharacterCreation.PlaceItemIn( this, 122, 53, new SpecialDonateDye() );
			CharacterCreation.PlaceItemIn(this, 11158, 53, (item = new PigmentsOfTokuno( 5 )));
		...
		public VioletDonationBoxAos( Serial serial ) : base( serial )
		{
		}
