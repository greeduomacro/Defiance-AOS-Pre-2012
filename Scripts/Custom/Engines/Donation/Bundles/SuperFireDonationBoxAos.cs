...
namespace Server.Items
{
	...
	public class SuperFireDonationAos : MetalBox
	{
		[Constructable]
		public SuperFireDonationAos()
		{
			Weight = 1.0;
			Hue = 1372;
			Item item = null;
			Name = "Defiance SuperFire Member Box of Holding";
			...
			item.Hue = 1372;
			item.Name = "Super Fire Shroud of Shadows";
			...
			item.Hue = 1372; //Utility.RandomList(1372, 1281, 1161, 1372, 1372, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;

			CharacterCreation.PlaceItemIn( this, 122, 53, new SpecialDonateDye() );
			CharacterCreation.PlaceItemIn(this, 11372, 53, (item = new PigmentsOfTokuno( 5 )));
		...
		public SuperFireDonationAos( Serial serial ) : base( serial )
		{
		}
