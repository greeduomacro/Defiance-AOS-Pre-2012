...
namespace Server.Items
{
	...
	public class InvulBlueDonationBoxAoS : MetalBox
	{
		[Constructable]
		public InvulBlueDonationBoxAoS()
		{
			Weight = 1.0;
			Hue = 1266;
			Item item = null;
			Name = "Defiance Invulnerability Member Box of Holding";
			...
			item.Hue = 1266;
			item.Name = "Invulnerability Shroud of Shadows";
...
//			CharacterCreation.PlaceItemIn(this, 74, 64, new DonationBandana());
		//Replaced the bandana with a deed - Edit by Blady
			...
			item.Hue = 1266; // Utility.RandomList(1150, 1281, 1161, 33, 1158, 1167, 1266, 1420, 1109, 1645);
			item.LootType = LootType.Blessed;
			...
			((PigmentsOfTokuno)item).Type = PigmentType.InvulnerabilityBlue; //Blady
		...
		public InvulBlueDonationBoxAoS( Serial serial ) : base( serial )
		{
		}
