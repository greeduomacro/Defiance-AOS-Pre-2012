...
namespace Server.Guilds
{
	...
	public class GuildDiplomacyGump : BaseGuildListGump<Guild>
	{
		...
		public GuildDiplomacyGump( PlayerMobile pm, Guild g )
			//changed by blady, default was GuildDisplayType.All
			: this( pm, g, GuildDiplomacyGump.NameComparer.Instance, true, "", 0, GuildDisplayType.AwaitingAction, Utility.CastConvertList<BaseGuild, Guild>( new List<BaseGuild>( Guild.List.Values ) ), (1063136 + (int)GuildDisplayType.AwaitingAction) )
