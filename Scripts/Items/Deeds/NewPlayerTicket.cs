	...
	public class NewPlayerTicket : Item
	{
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( Mobile from, NewPlayerTicket ticket ) : base( 50, 50 )
			{
				...
				AddHtml( 80, 200, 320, 35, "A full Spellbook and bag of reagents", false, false );
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				switch ( info.ButtonID )
				{
					...
					case 3: item = new Spellbook(UInt64.MaxValue); item2 = new BagOfReagents(30); number = 0; break;
				...
				if ( item != null )
				{
					...
					if (number == 0)
						m_From.SendMessage("A full spellbook and a bag of reagents have been placed into your backpack.");
					else
