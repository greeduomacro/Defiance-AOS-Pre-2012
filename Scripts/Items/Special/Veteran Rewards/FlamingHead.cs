...
{
	public class FlamingHeadOSI : StoneFaceTrapNoDamage, IAddon, IRewardItem
	{
		...
		public Item Deed
		{
			get
			{
				FlamingHeadOSIDeed deed = new FlamingHeadOSIDeed();
		...
		[Constructable]
		public FlamingHeadOSI() : this( StoneFaceTrapType.NorthWall )
		{
		}

		[Constructable]
		public FlamingHeadOSI( StoneFaceTrapType type ) : base()
		{
		...
		public FlamingHeadOSI( Serial serial ) : base( serial )
		{
		}
	...
	public class FlamingHeadOSIDeed : Item, IRewardItem
	{
		...
		[Constructable]
		public FlamingHeadOSIDeed() : base( 0x14F0 )
		{
			LootType = LootType.Blessed;
			Weight = 1.0;
		}

		public FlamingHeadOSIDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			private FlamingHeadOSIDeed m_Head;

			public InternalTarget( FlamingHeadOSIDeed head ) : base( -1, true, TargetFlags.None )
			{
				m_Head = head;
			}
					...
					if ( house != null && house.IsOwner( from ) )
					{
						...
						if ( house != null && house.IsOwner( from ) )
						{
							if ( map.CanFit( p3d, id.Height ) )
							{
								...
								FlamingHeadOSI head = null;

								if ( north && west )
									head = new FlamingHeadOSI( StoneFaceTrapType.NorthWestWall );
								else if ( north )
									head = new FlamingHeadOSI( StoneFaceTrapType.NorthWall );
								else if ( west )
									head = new FlamingHeadOSI( StoneFaceTrapType.WestWall );
