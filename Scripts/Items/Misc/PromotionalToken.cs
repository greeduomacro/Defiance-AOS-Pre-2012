...
namespace Server.Items
{
	public abstract class PromotionalToken : Item
	{
		...
		public virtual bool DonationOnly{ get{ return false; } }
		...
		{
			if ( DonationOnly && from is PlayerMobile && !((PlayerMobile)from).HasDonated )
				from.SendMessage( "You must be a donator to use this promotion." );
