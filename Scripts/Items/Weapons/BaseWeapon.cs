    ...
    public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability, IAosAttributes
    {
        ...
        public virtual bool CheckHit(Mobile attacker, Mobile defender)
        {
            ...
            if (Core.AOS)
            {
                ...
                if (defender is PlayerMobile)
                    bonus += ((PlayerMobile)defender).GetFortuneDefendChanceMod();
                //end sphynx
                ...
                if (SkillHandlers.Discordance.GetEffect(defender, ref discordanceEffect))
        ...
        public virtual TimeSpan GetDelay(Mobile m)
        {
            ...
            else if (Core.AOS)
            {
                ...
                double ticks = Math.Floor((80000.0 / ((m.Stam + 100) * speed)) - 2);

                if (ticks < 5.0) //Capped at 1.25secs
                    ticks = 5.0;
        ...
        public static bool CheckParry(Mobile defender)
        {
            ...
            else if (!(defender.Weapon is Fists) && !(defender.Weapon is BaseRanged))
            {
                ...
                //if( defender.Dex < 80 )
                //	chance = chance * (20 + defender.Dex) / 100;
                //*** End edit ***\\ uncommented, because not osi-like.
        ...
        public virtual double GetAosDamage(Mobile attacker, int bonus, int dice, int sides)
        {
            ...
            damage = (int)((damage / 100) * (attacker.Skills.EvalInt.Value / 120)); //vite core is return (damage/ 100)
            if (damage > 0) //vite
                return damage;//vite
            else
                return 1;//vite
