...
namespace Server.Items
{
	public abstract class BaseHat : BaseClothing, IShipwreckedItem
	{
		...
		public override int OnCraft( int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, BaseTool tool, CraftItem craftItem, int resHue )
		{
			...
			//Added by Blady: Hats receive runic bonuses.
	...
	public class Bandana : BaseHat
	{
		...
		public override void OnAdded(Object parent)
		{
			...
			if ( pm != null && pm.HasDonated && pm.DonationTimeLeft >= TimeSpan.FromDays(30.0))
			{
				m_Updated = true;
				m_OriginalHue = Hue;
				if (m_OriginalHue == 0)
				{
					Hue = DonationSystem.GetBandanaHue((Account)pm.Account);
				}
			}
			base.OnAdded(parent);
		}
