...
namespace Server.Items
{
	...
	public abstract class BaseClothing : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IAosAttributes
	{
		#region Factions
		...
		// *** ***
		private string m_CustomPropName;
		[CommandProperty(AccessLevel.Administrator)]
		public string CustomPropName
		{
			get { return m_CustomPropName; }
			set { m_CustomPropName = value; InvalidateProperties(); }
		}
		// *** ***
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			//Added Total Resists:
			int totalres = (PhysicalResistance + FireResistance + ColdResistance + PoisonResistance + EnergyResistance);
			if (totalres != 0 && totalres != PhysicalResistance && totalres != ColdResistance && totalres != FireResistance && totalres != PoisonResistance && totalres != EnergyResistance)
				list.Add(1060847, "Total Resist\t{0}%", totalres.ToString());// ~1_val~ ~2_val~
			...
			// *** ***
			if (m_CustomPropName != null)
				list.Add(1070722, m_CustomPropName);
			// *** ***
		}
