...
namespace Server.Items
{
	...
	public abstract class TrapableContainer : BaseContainer, ITelekinesisable
	{
		...
		// ***
		private bool m_PlayerTrap;
		private bool m_TrapActive;

		[CommandProperty(AccessLevel.GameMaster)]
		public bool PlayerTrap
		{
			get { return m_PlayerTrap; }
			set { m_PlayerTrap = value; }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool TrapActive
		{
			get { return m_TrapActive; }
			set { m_TrapActive = value; }
		}
		// ***
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			// Version 2
			writer.Write((bool)m_PlayerTrap);
			writer.Write((bool)m_TrapActive);
