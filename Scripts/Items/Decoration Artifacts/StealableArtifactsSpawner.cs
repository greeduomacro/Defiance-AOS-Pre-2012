		...
		private static StealableEntry[] m_Entries = new StealableEntry[]
			{
				...
				new StealableEntry( Map.Malas, new Point3D( 317,  56, -1 ), 4320, 6480, typeof( RockArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 360,  31,  8 ), 4320, 6480, typeof( SkullCandleArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 369, 372, -1 ), 4320, 6480, typeof( BottleArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 378, 372,  0 ), 4320, 6480, typeof( DamagedBooksArtifact ) ),
				// Doom - Artifact rarity 2
				new StealableEntry( Map.Malas, new Point3D( 432,  16, -1 ), 8640, 12960, typeof( StretchedHideArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 489,   9,  0 ), 8640, 12960, typeof( BrazierArtifact ) ),
				// Doom - Artifact rarity 3
				new StealableEntry( Map.Malas, new Point3D( 471,  96, -1 ), 12960, 14400, typeof( LampPostArtifact ), GetLampPostHue() ),
				new StealableEntry( Map.Malas, new Point3D( 421, 198,  2 ), 12960, 14400, typeof( BooksNorthArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 431, 189, -1 ), 12960, 14400, typeof( BooksWestArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 435, 196, -1 ), 12960, 14400, typeof( BooksFaceDownArtifact ) ),
				// Doom - Artifact rarity 5
				new StealableEntry( Map.Malas, new Point3D( 447,   9,  8 ), 14400, 20160, typeof( StuddedLeggingsArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 423,  28,  0 ), 14400, 20160, typeof( EggCaseArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 347,  44,  4 ), 14400, 20160, typeof( SkinnedGoatArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 497,  57, -1 ), 14400, 20160, typeof( GruesomeStandardArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 381, 375, 11 ), 14400, 20160, typeof( BloodyWaterArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 489, 369,  2 ), 14400, 20160, typeof( TarotCardsArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 497, 369,  5 ), 14400, 20160, typeof( BackpackArtifact ) ),
				// Doom - Artifact rarity 7
				new StealableEntry( Map.Malas, new Point3D( 475,  23,  4 ), 20160, 23040, typeof( StuddedTunicArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 423,  28,  0 ), 20160, 23040, typeof( CocoonArtifact ) ),
				// Doom - Artifact rarity 8
				new StealableEntry( Map.Malas, new Point3D( 354,  36, -1 ), 23040, 28800, typeof( SkinnedDeerArtifact ) ),
				// Doom - Artifact rarity 9
				new StealableEntry( Map.Malas, new Point3D( 433,  11, -1 ), 28800, 31680, typeof( SaddleArtifact ) ),
				new StealableEntry( Map.Malas, new Point3D( 403,  31,  4 ), 28800, 31680, typeof( LeatherTunicArtifact ) ),
				// Doom - Artifact rarity 10
				new StealableEntry( Map.Malas, new Point3D( 257,  70, -2 ), 43200, 55296, typeof( ZyronicClaw ) ),
				new StealableEntry( Map.Malas, new Point3D( 354, 176,  7 ), 43200, 55296, typeof( TitansHammer ) ),
				new StealableEntry( Map.Malas, new Point3D( 369, 389, -1 ), 43200, 55296, typeof( BladeOfTheRighteous ) ),
				new StealableEntry( Map.Malas, new Point3D( 467,  92,  4 ), 43200, 55296, typeof( InquisitorsResolution ) ),
				// Doom - Artifact rarity 12
				new StealableEntry( Map.Malas, new Point3D( 487, 364, -1 ), 72000, 86400, typeof( RuinedPaintingArtifact ) ),


				//Cursed Cave arties:
				new StealableEntry( Map.Felucca, new Point3D( 6048, 327, 28 ),   600,   660, typeof( SRCRSturdySaw ) ),
				new StealableEntry( Map.Felucca, new Point3D( 6039, 352, 49 ),   600,   660, typeof( SRCRSturdySmithHammer ) ),
				new StealableEntry( Map.Felucca, new Point3D( 6123, 272, 28 ),  2400,  3000, typeof( SRCRSturdyProspectorsTool ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5240, 1495, 0 ),  3600,  3700, typeof( SRCRSmallWeb ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5195, 1424, 8 ),  4200,  4320, typeof( SRCREmptyToolKit ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5190, 1423, 11),  4200,  4320, typeof( SRCRWallTorchSouth ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5152, 1480, 11),  4200,  4320, typeof( SRCRWallTorchEast ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5239, 1500, 6 ),  4800,  4900, typeof( SRCRBooks ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5343, 1469, 0 ),  5760,  5820, typeof( SRCRPluckedChicken ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5218, 1448, 0 ), 23040, 24000, typeof( SRCRBrokenChestOfDrawers ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5136, 1483, 6 ), 23040, 24000, typeof( SRCREmptyTub ) ),
				new StealableEntry( Map.Felucca, new Point3D( 5128, 1490, 6 ), 27000, 28000, typeof( SRCRBucket ) )
