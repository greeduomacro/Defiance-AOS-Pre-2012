...
namespace Server.Accounting {
	public class SyncDB {
		...
		private static readonly string m_ConnectString = "Server=dfi.defianceuo.com;Database=ShardInfo;User ID=Shardinfo;password=3RouFoeyoatoa4;port=3306";
//		private static readonly string m_ConnectString = "Server=localhost;Database=ShardInfo;User ID=root;password=root;port=3306";
