...
//					return m_NewHavenInfo;
			...
			if (useBritain)
				return new CityInfo("Britain", "Sweet Dreams Inn", 1496, 1610, 21, Map.Felucca);
			else
			{
				CityInfo cityInfo = args.City;
				if (cityInfo.Map == Map.Trammel)
					cityInfo.Map = Map.Felucca;
		...
		private static void SetSkills( Mobile m, SkillNameValue[] skills, int prof )
		{
			...
			switch ( prof )
			{
				...
				case 4: // Necromancer
				{
					...
					Spellbook book = new NecromancerSpellbook( (ulong)0x1CFFF ); // Silver: All except VE/VS // old: animate dead, evil omen, pain spike, summon familiar, wraith form
...
*/
					...
					Spellbook book = new Spellbook( (ulong)0xFFFFFFFFFFFFFF ); // A spellbook with all 1st - 7th spells.
