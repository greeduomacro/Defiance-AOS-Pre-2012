...
namespace Server
{
	public class LootPack
	{
		...
		public static readonly LootPack SePoor = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "3d10+20" ), //default 2d10+20
		...
		public static readonly LootPack SeAverage = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, AosMagicItemsAverageType1, 32.80, 1, 5, 0, 50 ),
				new LootPackEntry( false, AosMagicItemsAverageType1, 32.80, 1, 5, 0, 75 ),
		...
		public static readonly LootPack SeRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "15d10+200" ), //default 15d10+225
				new LootPackEntry( false, AosMagicItemsRichType1,	 76.30, 1, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 76.30, 1, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 76.30, 1, 5, 30, 100 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 40.00, 3, 5, 60, 100 ),
				new LootPackEntry( false, AosMagicItemsRichType1,	 76.30, 2, 5, 20, 100 ),
				new LootPackEntry( false, AosMagicItemsRichType2,	 30.00, 1, 5, 0, 100 ),
				new LootPackEntry( false, Instruments,				  1.00, 1 )
			} );

		public static readonly LootPack SeFilthyRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						   100.00, "3d75+200" ), //default 3d100+400
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	100.00, 1, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	100.00, 2, 5, 0, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	79.50, 3, 5,  0, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	79.50, 1, 5, 30, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	40.00, 3, 5, 60, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType1,	50.00, 3, 5, 40, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	20.00, 1, 5, 10, 100 ),
				new LootPackEntry( false, AosMagicItemsFilthyRichType2,	 5.00, 1, 5, 10, 100 ),
				new LootPackEntry( false, Instruments,					 2.00, 1 )
			} );

		public static readonly LootPack SeUltraRich = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "4d50+400" ), //default "6d100+600"
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	 30.00, 3, 5, 40, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	 30.00, 3, 5, 40, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	 50.00, 3, 5, 60, 100 ),
				new LootPackEntry( false, Instruments,				  2.00, 1 )
			} );

		public static readonly LootPack SeSuperBoss = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "4d50+600" ), //10d100+800
				...
				new LootPackEntry( false, AosMagicItemsUltraRich,	 60.00, 3, 5, 60, 100 ),
		...
		public static LootPack Poor{ get{ return Core.AOS ? SePoor : OldPoor; } }
		public static LootPack Meager{ get{ return Core.AOS ? SeMeager : OldMeager; } }
		public static LootPack Average{ get{ return Core.AOS ? SeAverage : OldAverage; } }
		public static LootPack Rich{ get{ return Core.AOS ? SeRich : OldRich; } }
		public static LootPack FilthyRich{ get{ return Core.AOS ? SeFilthyRich : OldFilthyRich; } }
		public static LootPack UltraRich{ get{ return Core.AOS ? SeUltraRich : OldUltraRich; } }
		public static LootPack SuperBoss{ get{ return Core.AOS ? SeSuperBoss : OldSuperBoss; } }
		#endregion
		...
		public static LootPack[] m_LootPacks = new LootPack[]
			{
				Poor, Meager, Average, Rich, FilthyRich, UltraRich, SuperBoss
			};

		public static LootPack GetLootPackFromFame( int fame )
		{
			return m_LootPacks[Math.Min( Math.Max( ( fame / 5000 ), 2 ), 6 )];
		}
	}
	...
	public class LootPackEntry
	{
		...
		public static Item Mutate( Item item, int value, CraftResource resource )
		{
			...
			return Mutate( item, attributeCount, min, max, value );
		}

		public static Item Mutate( Item item, int attributeCount, int min, int max, int value )
		{
			if (item != null)
			{
				if (item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat)
				{
					...
					{
						if (item is BaseWeapon)
							BaseRunicTool.ApplyAttributesTo((BaseWeapon)item, false, value, attributeCount, min, max);
						else if (item is BaseArmor)
							BaseRunicTool.ApplyAttributesTo((BaseArmor)item, false, value, attributeCount, min, max);
						else if (item is BaseJewel)
							BaseRunicTool.ApplyAttributesTo((BaseJewel)item, false, value, attributeCount, min, max);
						else if (item is BaseHat)
							BaseRunicTool.ApplyAttributesTo((BaseHat)item, false, value, attributeCount, min, max);
					}
				}
				else if (item is BaseInstrument)
				{
		...
		public static void AddRandomLoot( Container c, int amount, Mobile from, int minAttributeCount, int maxAttributeCount, int min, int max )
		{
			AddRandomLoot(c, amount, from.Luck, minAttributeCount, maxAttributeCount, min, max);
		}

		public static void AddRandomLoot( Container c, int amount, int value, int minAttributeCount, int maxAttributeCount, int min, int max )
		{
			for (int i = 0; i < amount; i++)
			{
				if ( c != null )
				{
					if ( 0.02 > Utility.RandomDouble() )
					{
						...
						c.DropItem( Mutate( Loot.RandomArmorOrShieldOrWeaponOrJewelry(), Utility.RandomMinMax( minAttributeCount, maxAttributeCount ), min, max, value ) );
				}
			}
		}

		public static void AddMoreLoot( BaseCreature creature, Container c, bool spawning, int luck, int lootPackAmount )
		{
			if ( creature == null || c == null )
				return;

			for ( int i = 0; i < lootPackAmount; ++i )
			{
				LootPack pack = LootPack.GetLootPackFromFame( creature.Fame );
				if ( pack != null )
					pack.Generate( creature, c, spawning, luck );
			}
		}
