...
namespace Server.Misc
{
	public class ClientVerification
	{
		...
		private static void SendAnnoyGump( Mobile m )
		{
			...
			{
				Gump g = new WarningGump( 1060637, 30720, String.Format( "Your client is out of date. Please update your client.<br>This server recommends that your client is always up to date, or at least version {0}.<br> <br>You are currently using version {1}.<br> <br>To patch, run UOPatch.exe inside your Ultima Online folder. If the auto updating fails, you may need to reinstall your client first. You may also need to update Razor Loader, otherwise you may be unable to connect.", Required, m.NetState.Version ), 0xFFC000, 480, 360,
					delegate( Mobile mob, bool selection, object o )
					{
						...
						Timer.DelayCall( TimeSpan.FromMinutes( Utility.Random( 5, 30 ) ), delegate { SendAnnoyGump( m ); } );
					}, null, false );
