...
namespace Server.Commands
{
	public class CommandHandlers
	{
		public static void Initialize()
		{
			...
			Register( "Move", AccessLevel.GameMaster, new CommandEventHandler( Move_OnCommand ) ); // Set to Counselor by Silver
			...
			else if ( e.Length == 2 || e.Length == 3 )
			{
				...
				if ( map != null )
				{
					try
					{
						 ...
						 */
						int x = int.Parse( e.GetString( 0 ).Replace(",","") );
						int y = int.Parse( e.GetString( 1 ).Replace(",","") );
						int z = (e.Length == 3 ) ? int.Parse( e.GetString( 2 ).Replace(",","") ) : map.GetAverageZ( x, y );
